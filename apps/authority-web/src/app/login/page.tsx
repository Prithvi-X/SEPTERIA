    ...
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <div className="flex justify-center">
          <div className="w-12 h-12 rounded-xl bg-blue-600/20 border border-blue-500/30 flex items-center justify-center text-blue-400 shadow-lg shadow-blue-900/20">
        ...
        <p className="mt-1 text-center text-xs font-medium text-slate-400 uppercase tracking-wider">
          Authority & Welfare Administrative Portal
        </p>
            ...
            <div>
              ...
              <div className="mt-1.5 relative">
                ...
                <input
                  ...
                  placeholder="officer@septeria.gov.in"
                  className="block w-full pl-10 pr-3.5 py-2.5 bg-slate-950 border border-slate-800 rounded-lg text-sm text-slate-200 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                />
              </div>
            </div>
